...
//   const listShippingCost  = [
//   {
//     title: 'JNE-OKE',
//     description: '3-6 Hari'
//   },
//   {
//     title: 'JNE-REG',
...
const top100Films = [
  ...
  function getProvince () {
    ...
    let options = {
      headers: {
        Key: '9480a902932937f1952020b03e152a9e'
      }
    }
    axios.get('https://api.rajaongkir.com/starter/province',options).then((response)=> {
